...
2. Create a [config file](./config/) at `config/config.json` using the contents of `setup/docker/config-docker.json`. It reflects the redis hostnames as defined in the docker-compose services.
